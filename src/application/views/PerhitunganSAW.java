...
public class PerhitunganSAW extends javax.swing.JPanel {
    ...
    public void getDataNormalisasi() {
        ...
        model.setColumnIdentifiers(new Object[]{"Nama Perawatan", "Nama Kriteria", "Nilai Normalisasi"});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String templateName = "ReportNormalisasiPerawatan.jrxml";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try {
            String templateName = "ReportRangkingPerawatan.jrxml";
            InputStream reportStream = ReportView.class.getResourceAsStream("/resources/reports/" + templateName);
            JasperDesign jd = JRXmlLoader.load(reportStream);
