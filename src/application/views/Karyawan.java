...
import net.sf.jasperreports.view.JasperViewer;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("Alamat: " + deskripsi);
        

        // Set ke model
        KaryawanModel karyawan = new KaryawanModel();
        karyawan.setName(nama);
        karyawan.setDescription(deskripsi);
...
//         Simpan ke DB (uncomment baris ini untuk mengaktifkan penyimpanan)
         ...
         if (result > 0) {
             JOptionPane.showMessageDialog(this, "Data perawatan berhasil disimpan.");
             getAllData();
             clearForm();
         } else {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (result > 0) {
            JOptionPane.showMessageDialog(this, "Data perawatan berhasil diperbarui.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String templateName = "LaporanPerawatan.jrxml";
