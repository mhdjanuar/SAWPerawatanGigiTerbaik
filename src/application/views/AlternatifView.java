...
public class AlternatifView extends javax.swing.JPanel {
    ...
    public void getAllData() {
        ...
        model.setColumnIdentifiers(new Object[]{"Nama Perawatan", "Nama Kriteria", "Bobot Alternatif"}); // Menentukan nama kolom
    ...
    public AlternatifView() {
      ...
      // === Pelanggan ===
      JLabel pelangganLabel = new JLabel("Perawatan: ");
      ...
      pelangganComboBox.addItem(new ComboBoxItem("Pilih Perawatan", -1));
      ...
      simpanButton.addActionListener(e -> {
          ...
          if (selectedPelanggan == null || selectedPelanggan.getId() == -1) {
              JOptionPane.showMessageDialog(this, "Pilih perawatan terlebih dahulu.", "Error", JOptionPane.ERROR_MESSAGE);
              return;
          }
